...
const testimonials = [
  {
    quote:
      "After the very first session the difference was incredible. I walked in with a stiff neck and walked out standing straight. Absolutely remarkable.",
    author: "Jacques B.",
    location: "Malmesbury",
  },
  {
  ...
  {
    quote:
      "Janet and her team have saved my life after almost suffering from daily headaches and neck spasms. Instant release after the very 1st session.",
    author: "Client",
      ...
      <div className="max-w-6xl mx-auto">
        <AnimatedSection>
          ...
          <p className="text-white/50 text-center max-w-xl mx-auto mb-12">
            Hear from clients whose lives have been changed by Body Alignment
            therapy.
          </p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none">
          {testimonials.map((t, i) => (
            <AnimatedSection key={i} delay={i * 0.12}>
              <div className="bg-white rounded-2xl p-7 shadow-sm snap-center min-w-[300px] md:min-w-0 flex flex-col">
